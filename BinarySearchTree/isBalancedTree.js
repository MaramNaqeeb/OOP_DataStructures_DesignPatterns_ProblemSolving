var Height = function (node) {
  ...
  return Math.max(Height(node.left), Height(node.right)) + 1; // here I get the height of the left and right nodes and add 1 to add the parent node for the left and right nodes
};
